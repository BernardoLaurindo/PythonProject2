...
def calculate_demographic_data(print_data=True):
    ...
    country_percent = (country_earnings / country_total * 100).dropna()
    ...
    india_ocupation = df[(df['native-country'] == 'India') & (df['salary'] == '>50K')]
    top_IN_occupation = india_ocupation['occupation'].value_counts().idxmax()
